    ...
    <>
      <main>
        {data && (
          <>
            <Helmet>
              <title>{`${data.title} - Investmate Project`}</title>
              <meta name="description" content={data.details.introduction} />
              <meta name="keywords" content={`${data.title}, investment project, ${data.details.join_investor_note}`} />
              <meta property="og:title" content={`${data.title} - Investmate Project`} />
              <meta property="og:description" content={data.details.introduction} />
              <meta property="og:type" content="website" />
              <meta property="og:url" content={window.location.href} />
              <meta name="twitter:card" content="summary_large_image" />
              <meta name="twitter:title" content={`${data.title} - Investmate Project`} />
              <meta name="twitter:description" content={data.details.introduction} />
            </Helmet>
