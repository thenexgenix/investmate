                ...
                <div className="hero-content flex-col lg:flex-row-reverse !justify-around gap-20">
                    ...
                    <div>
                        ...
                        <h1 className="text-5xl my-10 font-bold">
                            ...
                            <span className='text-[#00B67A]'>Unless</span> You Act Today!
                        </h1>
                        <hr />
                        ...
                        <div className='flex flex-col justify-around gap-5 my-10'>
                            <div className='flex gap-5'>
                                <img className='w-6 h-6' src={joinUsSectionIcon1} alt="Global Community Icon" />
                                <div>
                            ...
                            <div className='flex gap-6'>
                                <img className='w-6 h-6' src={joinUsSectionIcon2} alt="Crowdfunding Icon" />
                                <div>
                        ...
                        {/* Avatar Group Showing Community Members */}
                        <div
                            className="avatar-group -space-x-6 w-fit p-3 rounded-full"
                            style={{
                                background: "linear-gradient(4.22deg, rgb(0, 182, 122) -91.818%, rgb(46, 116, 236) -63.532%, rgb(0, 182, 122) 12.024%, rgb(46, 116, 236) 134.09%)",
                            }}
                        >
                            {/* Sample Avatars */}
                            ...
                            {/* Placeholder Avatar Indicating More Users */}
                        ...
                        {/* Progress Bar Showing Platform Growth/Activity */}
